...
image:docs/labs/intro-cjbang/images/camel-jbang.png[width=15%] _Camel JBang_ is a command-line interface (CLI) that helps you run, iterate, and test your _Apache Camel_ applications without complex setups. It accelerates prototyping: create, validate, and tweak flows quickly—ideal for rapid experimentation and for getting a feel of what _Camel_ can do. 
