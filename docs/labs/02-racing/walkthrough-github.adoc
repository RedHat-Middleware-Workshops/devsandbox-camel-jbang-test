...
If you enjoyed the playful theme of the lab and you'd like to take it further with your own experiments, read below some suggested ideas for you, but you're ultimately the creator of your own adventures!
...
Think of ways to introduce weather variables to the race. For instance, you could redifine the pace of the cars based on the weather conditions. Rainy conditions could make the cars slower.
...
==== Be the creator of your own adventure
